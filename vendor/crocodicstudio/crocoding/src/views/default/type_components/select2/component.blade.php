@if($form['datatable'])
    ...
    @else
        @if($form['datatable_ajax'] == true)
            ...
            $url = \crocodicstudio\crocoding\helpers\Crocoding::mainpath("find-data");
...
<div class='form-group {{$header_group_class}} {{ (isset($errors))?($errors->first($name))?"has-error":"":"" }}' id='form-group-{{$name}}' style="{{@$form['style']}}">
    ...
    <select style='width:100%' class='form-control' id="{{$name}}"
        ...
        @if($form['datatable'])
            @if($form['relationship_table'])
                ...
                $pk = \crocodicstudio\crocoding\helpers\Crocoding::findPrimaryKey($select_table);
                ...
                $foreignKey = \crocodicstudio\crocoding\helpers\Crocoding::getForeignKey($table, $form['relationship_table']);
                $foreignKey2 = \crocodicstudio\crocoding\helpers\Crocoding::getForeignKey($select_table, $form['relationship_table']);
            ...
            @else
                @if($form['datatable_ajax'] == false)
                    ...
                    $select_table_pk = \crocodicstudio\crocoding\helpers\Crocoding::findPrimaryKey($select_table);
                    ...
                    if (\crocodicstudio\crocoding\helpers\Crocoding::isColumnExists($select_table, 'deleted_at')) {
    ...
    <div class="text-danger">
        {!! (isset($errors))?$errors->first($name)?"<i class='fa fa-info-circle'></i> ".$errors->first($name):"":"" !!}
    </div><!--end-text-danger-->
