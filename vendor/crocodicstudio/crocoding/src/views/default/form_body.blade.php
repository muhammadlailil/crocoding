...
$placeholder = (@$form['placeholder']) ? 'placeholder="'.$form['placeholder'].'"' :  'placeholder="'.$form['label'].'"';
...
?>
@if(file_exists(base_path('/vendor/crocodicstudio/crocoding/src/views/default/type_components/'.$type.'/component.blade.php')))
    @include('crocoding::default.type_components.'.$type.'.component')
@elseif(file_exists(resource_path('views/vendor/crocoding/type_components/'.$type.'/component.blade.php')))
    @include('vendor.crocoding.type_components.'.$type.'.component')
@else
