...
@section("content")
            ...
            $(function () {
                ...
                $(document).on('click', '.sub li', function () {
                    ...
                    if (input_name == 'type[]') {
                        ...
                        $.getJSON("{{\crocodicstudio\crocoding\helpers\Crocoding::mainpath('type-info')}}/" + v, function (data) {
                ...
                $('#myModal .btn-save-option').click(function () {
                    ...
                    //Validation
                    var i_required = [];
                    $('#myModal .bodyModal .required').each(function () {
                        var value = $(this).val();
                    ...
                    //Validation
                    var i_required_one = [];
                    $('#myModal .bodyModal .required-one').each(function () {
                        var value = $(this).val();
                        var name = $(this).attr('name');
                        if (value == '') {
                    ...
                    if (i_required_one.length > 0 && i_required_one.length == $('#myModal .bodyModal .required-one').length) {
    ...
    <div id="myModal" class="modal ">
        ...
        <div class="footerModal text-right">
            <a href="#close-modal" rel="modal:close" class="btn btn-white" data-dismiss="modal">Close</a>
        ...
        <form method="post" action="{{Route('ModulsControllerPostStep4')}}">
            ...
            <div class="card card-small mb-4">
                    ...
                    <div class="pull-right">
                        <div class="btn-group btn-group-sm d-flex my-auto mx-auto mx-sm-0">
                            @if($id)
                                ...
                                <a class="btn btn-white active" href="{{Route('ModulsControllerGetStep3',['id'=>$id])}}">
                    ...
                    <table class='table-form table table-striped'>
                        ...
                        @foreach($cb_form as $form)
                            <tr>
                                ...
                                <td>
                                    <select class='custom-select custom-select-sm width' name='width[]'>
                                        @for($i=10;$i>=1;$i--)
                                ...
                                <td>
                                    ...
                                    <div class='option_area' style="display: none">
                                        ...
                                        $type = $form["type"] ?: "text";
                                        $types = base_path('vendor/crocodicstudio/crocoding/src/views/default/type_components/'.$type.'/info.json');
                ...
                <div class="card-footer">
                    <div align="right">
                        <button type="button" onclick="location.href='{{\crocodicstudio\crocoding\helpers\Crocoding::mainpath('step2').'/'.$id}}'" class="btn btn-default">&laquo; Back</button>
                        <input autocomplate="off" type="submit" class="btn btn-primary" value="Step 4 &raquo;">
                    </div>
                </div>
