    ...
    @push('bottom')
        <script>
            ...
            function load_response() {
                ...
                no_params += 1;
                $('#table-response tbody').append("<tr><td>" + no_params + "</td><td>api_status</td><td>boolean</td><td>-</td><td><select class='custom-select' disabled><option>YES</option></select></td><td>-</td></tr>");
                no_params += 1;
                $('#table-response tbody').append("<tr><td>" + no_params + "</td><td>api_message</td><td>string</td><td>-</td><td><select class='custom-select' disabled><option>YES</option></select></td><td>-</td></tr>");
                ...
                no_params = 0;
                $.get('{{url(config("crocoding.ADMIN_PATH"))."/api_generator/column-table"}}/' + t + '/' + type, function (resp) {
            ...
            <div class="card card-small mb-4">
                <div class="card-header border-bottom">
                    ...
                    <div class="pull-right">
                        <div class="btn-group btn-group-sm btn-group-toggle d-flex my-auto mx-auto mx-sm-0">
                            <a class="btn btn-white" href="{{ \crocodicstudio\crocoding\helpers\Crocoding::mainpath() }}">
                                <i class='fa fa-info'></i> API Documentation
                            </a>
                            <a class="btn btn-white active" href="{{ \crocodicstudio\crocoding\helpers\Crocoding::mainpath('generator') }}">
                ...
                <div class="card-body row cardBodyForm" style="padding-bottom: 0px !important;">
                    ...
                    <div class="col-sm-4">
                        <div class='form-group'>
                            <label>Table</label>
                            <select id='combo_tabel' name='tabel' required class='custom-select'>
                        ...
                        <div class="row">
                            <div class='col-sm-6'>
                                <div class='form-group'>
                                    ...
                                    <select id='tipe_action' name='aksi' required class='custom-select'>
                            ...
                            <div class='col-sm-6'>
                                <div class='form-group'>
                                    ...
                                    <label class='radio-inline'>
                                        <input type='radio' class='method_type' {{ ($row->method_type == 'post')?"checked":"" }} name='method_type'
                                               value='post'/> POST
                                    </label>
                    ...
                    <div class="col-sm-12">
                        <div class='form-group'>
                            <div class="clearfix">
                                ...
                                <a class='pull-right btn btn-xs btn-primary' href='javascript:void(0)' onclick="load_parameters()" style="padding: 2px 10px">
                            ...
                            <table id='table-parameters' class='table table-striped table-bordered'>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><select class='custom-select' name='params_type[]'>
                                    ...
                                    <td><select class='custom-select params_required' name='params_required[]'>
                                            <option value='1'>YES</option>
                                            <option value='0'>NO</option>
                                        </select></td>
                                    <td><select class='custom-select params_used' name='params_used[]'>
                                            <option value='1'>YES</option>
                                            <option value='0'>NO</option>
                                        </select></td>
                                    <td class='col-delete'><a class='btn btn-primary' href='javascript:void(0)' onclick='addParam()'><i
                        ...
                        <div class='form-group'>
                            ...
                            <div class='help-block'>Use [paramName] to get the parameter value. e.g : [id] or [email]. Do not use quotes or HTML
                                entities.<br>Password
                            ...
                            <div id='response'>
                                <table id='table-response' class='table table-striped table-bordered'>
                                    ...
                                    <tr class='tr-additional'>
                                        ...
                                        <td>
                                            <select class='custom-select' name='responses_type[]'>
                                                <option value='integer'>Integer</option>
                                                <option value='boolean'>Boolean</option>
                                                <option value='string'>String</option>
                                        ...
                                        <td><input placeholder="E.g : select sum(total) from order_detail where id_order = order.id"
                                                   name='responses_subquery[]'
                                                   class='form-control' type='text'>
                                            <small>Enter sub query without alias name</small>
                                        </td>
                                        <td><select class='custom-select responses_used' name='responses_used[]'>
                                                <option value='1'>YES</option>
                                                <option value='0'>NO</option>
                                            </select></td>
                ...
                <div class="card-footer">
                    <div>
                        <input autocomplate="off" type="submit" class="btn btn-primary" value="Save & Generate API">
                    </div>
                </div>
