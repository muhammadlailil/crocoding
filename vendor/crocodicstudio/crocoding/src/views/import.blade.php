...
@section('content')
    ...
    @if(g('file') && g('import'))
        ...
        <!-- Box -->
            <div id='card_main' class="card card-primary">
                        ...
                        <script type="text/javascript">
                            $(function () {
                                ...
                                var int_prog = setInterval(function () {
                                    ...
                                    $.post("{{ \crocodicstudio\crocoding\helpers\Crocoding::mainpath('do-import-chunk?file='.g('file')) }}", {resume: 1}, function (resp) {
                                ...
                                $.post("{{ \crocodicstudio\crocoding\helpers\Crocoding::mainpath('do-import-chunk').'?file='.g('file') }}", function (resp) {
                                    if (resp.status == true) {
                ...
                <div class="card-footer" id='upload-footer' style="display:none">
                    <a href='{{ \crocodicstudio\crocoding\helpers\Crocoding::mainpath("import-data") }}' class='btn btn-white'><i
                            class='fa fa-upload'></i> Upload Other File</a>
                    <a href='{{\crocodicstudio\crocoding\helpers\Crocoding::mainpath()}}' class='btn btn-success'>Finish</a>
                </div><!-- /.card-footer-->
        ...
        <!-- Box -->
            <div id='card_main' class="card card-primary">
                ...
                if ($data_sub_module) {
                    ...
                    $action_path = \crocodicstudio\crocoding\helpers\Crocoding::mainpath();
                }

                $action = $action_path . "/done-import?file=" . g('file') . '&import=1';
                ?>
                ...
                <form method='post' id="form" enctype="multipart/form-data" action='{{$action}}'>
                    ...
                    <div class="card-footer">
                        <a onclick="if(confirm('Are you sure want to leave ?')) location.href='{{ \crocodicstudio\crocoding\helpers\Crocoding::mainpath("import-data") }}'"
                           href='javascript:;'
        ...
        <!-- Box -->
            <div id='card_main' class="card card-primary">
                ...
                <form method='post' id="form" enctype="multipart/form-data" action='{{$action}}'>
                    ...
                    <div class="card-body">
                        ...
                        <div class='callout callout-success'>
                            ...
                            * This tool is generate data automatically so, be carefull about your table xls structure. Please make sure correctly the table
                            structure.<br/>
                            * Table structure : Line 1 is heading column , and next is the data. (For example, you can export any module you wish to XLS
                            format)
                        </div>
                    ...
                    <div class="card-footer">
                        <a href='{{ \crocodicstudio\crocoding\helpers\Crocoding::mainpath() }}' class='btn btn-white'>Cancel</a>
